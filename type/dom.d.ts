...
declare namespace Svelte
{
    ...
    interface DOMAttributes<T>
    {
        ...
        //Svelte
        onIntroStart?: Function;
        onIntroEnd?: Function;
        onOutroStart?: Function;
        onOutroEnd?: Function;
        ...
        onClick?: MouseEventHandler<T> | boolean;
    ...
    type ActionConfig = { destroy?: Function };

    interface HTMLAttributes<T> extends AriaAttributes, DOMAttributes<T>
    {
        // Svelte
        bindInnerHTML?: string;
        class?: string;
        bindRef?: HTMLElement;
        transition?: TransitionConfig;
        localTransition?: TransitionConfig;
        in?: TransitionConfig;
    ...
    interface InputHTMLAttributes<T> extends HTMLAttributes<T>
    {
        ...
        type?: string;
        value?: string | string[] | number;
        bindValue?: string | string[] | number; // Svelte
    ...
    interface OptionHTMLAttributes<T> extends HTMLAttributes<T>
    {
        ...
        label?: string;
        selected?: boolean;
        value?: string | string[] | number | object; // Svelte
    }
    ...
    interface SelectHTMLAttributes<T> extends HTMLAttributes<T>
    {
        ...
        size?: number;
        value?: string | string[] | number;
        bindValue?: string | string[] | number | object; // Svelte
        onChange?: ChangeEventHandler<T>;
    }
